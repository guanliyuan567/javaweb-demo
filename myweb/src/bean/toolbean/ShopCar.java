...
public class ShopCar {
     ...
     */
    public void addItem(bean.valuebean.GoodsSingle single) {
        if (single != null) {
            if (buylist.size() == 0) {                        //���buylist�в������κ���Ʒ
                bean.valuebean.GoodsSingle temp = new bean.valuebean.GoodsSingle();
                ...
                for (; i < buylist.size(); i++) {                //����buylist���϶����жϸü������Ƿ��Ѿ����ڵ�ǰҪ��ӵ���Ʒ
                    bean.valuebean.GoodsSingle temp = (GoodsSingle) buylist.get(i);        //��ȡbuylist�����е�ǰԪ��
                ...
                if (i >= buylist.size()) {                    //˵��buylist�в�����Ҫ��ӵ���Ʒ
                    bean.valuebean.GoodsSingle temp = new GoodsSingle();
                    temp.setName(single.getName());
                    temp.setPrice(single.getPrice());
                    temp.setNum(single.getNum());
                    buylist.add(temp);                    //�洢��Ʒ
    ...
    public void removeItem(String name) {
        for (int i = 0; i < buylist.size(); i++) {                    //����buylist���ϣ�����ָ����Ƶ���Ʒ
            bean.valuebean.GoodsSingle temp = (bean.valuebean.GoodsSingle) buylist.get(i);   //��ȡ�����е�ǰλ�õ���Ʒ
            //�����Ʒ�����Ϊname����ָ�������
